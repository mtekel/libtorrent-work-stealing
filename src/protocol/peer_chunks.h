...
public:
  ...
  rak::timer          START_timer() const           { return m_STARTTimer; }
  rak::timer          STOP_timer() const           { return m_STOPTimer; }
  void                set_have_timer(rak::timer t)  { m_haveTimer = t; }
  void                set_START_timer(rak::timer t) { m_STARTTimer = t; }
  void                set_STOP_timer(rak::timer t)  { m_STOPTimer = t; }
...
private:
  ...
  rak::timer          m_STARTTimer;
  rak::timer          m_STOPTimer;
...
PeerChunks::PeerChunks() :
  ...
  m_peerRate(10),				//there was 600

  m_downloadThrottle(10),		//there was 30
  m_uploadThrottle(10)			//there was 30
{
}
